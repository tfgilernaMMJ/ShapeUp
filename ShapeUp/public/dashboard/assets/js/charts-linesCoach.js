  ...
  data: {
    ...
    datasets: [
      ...
      },
      {
         ...
         * https://tailwindcss.com/docs/customizing-colors/#default-color-palette
         */
        backgroundColor: metricDiets !== 0 ? '#5fcf90' : 'red',
        borderColor: metricDiets !== 0 ? '#5fcf90' : 'red',
      ...
      },
      {
         ...
         * https://tailwindcss.com/docs/customizing-colors/#default-color-palette
         */
        backgroundColor: metricTrainings !== 0 ? '#00d35b' : 'red',
        borderColor: metricTrainings !== 0 ? '#00d35b' : 'red',
