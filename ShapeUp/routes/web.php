...
Route::get('/admin-editView/{type}/{id}/{category}', [App\Http\Controllers\AdminController::class, 'showEditView'])->name('edit');
Route::get('/admin-createView/{type}/{category}', [App\Http\Controllers\AdminController::class, 'showFormView'])->name('formCreateView');
