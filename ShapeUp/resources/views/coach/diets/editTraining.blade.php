...
<div class="container bg-transparent mt-5">
    <form action="{{route('coach.editTraining',['id' => $training->id])}}" enctype="multipart/form-data" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" value="{{ old('duration', $training->duration) }}" class="block w-full py-2 px-3 bg-gray-100 rounded-lg" id="duration" name="duration" placeholder="Duración" required>
        </div>
